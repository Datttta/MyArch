-- screenshot
hl.bind(MainMod .. " + CTRL + SHIFT + S", hl.dsp.exec_cmd("~/Repos/MyArch/storage/scripts/screenshot.sh"))
hl.bind(MainMod .. " + CTRL + SHIFT + A", hl.dsp.exec_cmd("grimblast --freeze --notify save screen"))
