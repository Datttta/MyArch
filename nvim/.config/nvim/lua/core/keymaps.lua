...
-- quit file
vim.keymap.set('n', '<leader>qw', '<cmd> q! <CR>', opts) -- saving
vim.keymap.set({ 'n', 'v' }, '<leader>qe', '<cmd> wq <CR>', opts) --without saving
...
vim.keymap.set('n', '<S-q>', vim.diagnostic.setloclist, { desc = 'Open diagnostics list' })
